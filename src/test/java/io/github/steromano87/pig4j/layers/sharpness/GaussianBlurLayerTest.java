...
class GaussianBlurLayerTest {
    @Test
    void testGaussianBlurLayerWithDefaultParameters() throws IOException {
        ...
        GaussianBlurLayer gaussianBlurLayer = new GaussianBlurLayer();
        generator.addLayer(gaussianBlurLayer);
    ...
    @Test
    void testGaussianBlurLayerWithSetRadius() throws IOException {
        ImageGenerator generator = new ImageGenerator(640, 400);
        ImageLayer imageLayer = new ImageLayer();
        Path imagePath = Paths.get("src/test/resources/common", "landscape_640_400.jpg");
        imageLayer.setImageFile(imagePath.toFile());
